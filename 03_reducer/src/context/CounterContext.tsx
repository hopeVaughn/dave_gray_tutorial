...
const useCounterContext = (initialState: StateType) => {
  ...
  const incremement = useCallback(() => dispatch({ type: REDUCER_ACTION_TYPE.INCREMENT }), [])

  const decremement = useCallback(() => dispatch({ type: REDUCER_ACTION_TYPE.DECREMENT }), [])
  ...
  return { state, incremement, decremement, handleTextInput }
}
